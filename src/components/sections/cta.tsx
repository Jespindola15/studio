  ...
  return (
    <section id="contact" className="py-20 md:py-32">
        <div className="container mx-auto px-4 max-w-4xl">
            <div className="relative text-center bg-gradient-to-r from-primary to-accent p-8 md:p-16 rounded-2xl overflow-hidden shadow-2xl shadow-primary/20">
                ...
                <div className="relative z-10">
                    <h2 className="text-3xl md:text-5xl font-bold font-headline text-primary-foreground">
                        Convierte tu presencia online en una herramienta de ventas
                    </h2>
